<?php
/**
 * Plugin Name: WP Rocket | No LazyLoad for Mobile Devices (without Mobile Cache)
 * Description: Disables LazyLoad for mobile devices when Mobile Cache not active.
